...
public class PlayWithAIMediumModeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_with_aimedium_mode);
        ...
        data = new OfflineData(PlayWithAIMediumModeActivity.this);
        intent = getIntent();

        oName = data.getStoredName();
        xName = intent.getStringExtra(AppVariables.INTENT_NAME);

        button1 = findViewById(R.id.offline_ai_medium_mode_button_1);
        button2 = findViewById(R.id.offline_ai_medium_mode_button_2);
        button3 = findViewById(R.id.offline_ai_medium_mode_button_3);
        button4 = findViewById(R.id.offline_ai_medium_mode_button_4);
        button5 = findViewById(R.id.offline_ai_medium_mode_button_5);
        button6 = findViewById(R.id.offline_ai_medium_mode_button_6);
        button7 = findViewById(R.id.offline_ai_medium_mode_button_7);
        button8 = findViewById(R.id.offline_ai_medium_mode_button_8);
        button9 = findViewById(R.id.offline_ai_medium_mode_button_9);
        display_turn = findViewById(R.id.offline_ai_medium_mode_display_turn);
        playground = findViewById(R.id.offline_ai_medium_mode_hall_view);

        displayPlayersTurn();

        Snackbar.make(findViewById(R.id.offline_ai_medium_mode_main_view),xName + " V/s " +  oName,Snackbar.LENGTH_LONG).show();
    }
    ...
    private void cpuMove() {
        CountDownTimer countDownTimer = new CountDownTimer(1000,500) {
            ...
            public void onFinish() {
                ...
                if (dwStatus == 1) {
                    if (counter > 2) {
                        buttonToPress = move.findBestMove(board);
                    }else {
                        buttonToPress = getMove();
                    }
    ...
    private void fillOById(int id) {
        switch (id) {
            case R.id.offline_ai_medium_mode_button_1 :
                board[0][0] = 'o';
                break;
            case R.id.offline_ai_medium_mode_button_2 :
                board[0][1] = 'o';
                break;
            case R.id.offline_ai_medium_mode_button_3 :
                board[0][2] = 'o';
                break;
            case R.id.offline_ai_medium_mode_button_4 :
                board[1][0] = 'o';
                break;
            case R.id.offline_ai_medium_mode_button_5 :
                board[1][1] = 'o';
                break;
            case R.id.offline_ai_medium_mode_button_6 :
                board[1][2] = 'o';
                break;
            case R.id.offline_ai_medium_mode_button_7 :
                board[2][0] = 'o';
                break;
            case R.id.offline_ai_medium_mode_button_8 :
                board[2][1] = 'o';
                break;
            case R.id.offline_ai_medium_mode_button_9 :
                board[2][2] = 'o';
                break;
        }
    }
    ...
    private void draw() {
        Snackbar.make(findViewById(R.id.offline_ai_medium_mode_main_view),"Game Draw!!",Snackbar.LENGTH_LONG).show();
        counter = 0;
        dwStatus = 0;
        holdScreen();
    }
    ...
    private void won() {
        ...
        dwStatus = 0;
        if (current_symbol == 'X') {
            Snackbar.make(findViewById(R.id.offline_ai_medium_mode_main_view),xName + " Won!",Snackbar.LENGTH_LONG).show();
        }else {
            Snackbar.make(findViewById(R.id.offline_ai_medium_mode_main_view),oName + " Won!",Snackbar.LENGTH_LONG).show();
        }
        holdScreen();
    }
